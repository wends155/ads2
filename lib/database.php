<?php
	class Database {
		...
		private static 	$dsn = 'mysql:host=localhost;dbname=wends',
						$user= 'root',
						$pass = '';
		...
		public static function insert($sql,$params){
			...
			if( $stmt->rowCount() ){
				return self::sql("SELECT * FROM students WHERE id IN (SELECT LAST_INSERT_ID())");
			}
			return false;
		}
